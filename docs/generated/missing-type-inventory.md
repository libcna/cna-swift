...
MEASURED_ACCESSOR_PROJECTIONS=108
PENDING_ACCESSOR_PROJECTIONS=6
GLOBAL_OPTIONAL_OPERATOR_PROJECTIONS=2
NONPUBLIC_CONSTRUCTION_PROJECTIONS=44
EVENT_PROJECTIONS=49
EVENT_SUPPORT_TYPE_MEASUREMENTS=4
BCL_SUPPORT_TYPE_MEASUREMENTS=20
XNA_SEALED_CLASS_PROJECTIONS=54
...
MEASURED_RETURN_NULLABILITY_PROJECTIONS=276
PENDING_RETURN_NULLABILITY_PROJECTIONS=93
OPTIONAL_RETURN_PROJECTIONS_OBSERVED=99
```
