...
extension Microsoft.Xna.Framework.Graphics {
    ...
    /// a dropped one.
    ///
    /// XNA raises it when no adapter satisfies the requested profile.
    /// Adapter enumeration is hardware the qualified HEADLESS host does
    /// not have, so nothing throws it yet.
    ///
    ...
    public final class NoSuitableGraphicsDeviceException: CNAException {
        /// `.ctor()`.
