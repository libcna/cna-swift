...
TARGET_TYPES=218               TARGET_MEMBERS=2636
COMPLETE_TYPES=212             PARTIAL_TYPES=6      MISSING_TYPE=39
MISSING_MEMBER=10              TOTAL_DIAGNOSTICS=52
...
`MISSING_TYPE=39`, `MISSING_MEMBER=10`, and `OVERLOAD_MAPPING_MISMATCH=3`,
...
```text
BOUND_FUNCTIONS=598  ROUTE_PAIRINGS=598  PROTOTYPE_TYPE_POSITIONS=2010
CANONICAL_DECLARATION_CHECKS=2010  C_SWIFT_MEASUREMENTS=2010
LAYOUTS=60  LAYOUT_FIELDS=466  CALLBACKS=8  CONSTANTS=228  SCALAR_FACTS=3
MISSING_HEADER_SYMBOLS=0  MISSING_LIBRARY_SYMBOLS=0  ABI_MISMATCHES=0
NATIVE_ABI_MUTATIONS=14  CAUGHT=14  SURVIVORS=0
PROJECTION_MUTATIONS=371  LAST_FULL_RUN=137  CAUGHT=135
