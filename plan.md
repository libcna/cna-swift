...
TARGET_TYPES=199               TARGET_MEMBERS=2462
COMPLETE_TYPES=193             PARTIAL_TYPES=6      MISSING_TYPE=58
MISSING_MEMBER=12              TOTAL_DIAGNOSTICS=72
ALLOWLIST_ENTRIES=0            UNMEASURED_STRUCTURAL_CATEGORY=0
NONDERIVABLE_UNSEALED_CLASSES=0    PENDING_BCL_BASE_TYPES=4
XNA_RESOURCE_STRING_PROJECTIONS=79 API_COMPAT_SELF_TESTS=2461
```

**Every remaining diagnostic is an absence.** Three categories are non-zero —
`MISSING_TYPE=58`, `MISSING_MEMBER=12`, and `OVERLOAD_MAPPING_MISMATCH=2`,
...
```text
BOUND_FUNCTIONS=416  ROUTE_PAIRINGS=416  PROTOTYPE_TYPE_POSITIONS=1448
CANONICAL_DECLARATION_CHECKS=1448  C_SWIFT_MEASUREMENTS=1448
...
PROJECTION_MUTATIONS=357  LAST_FULL_RUN=137  CAUGHT=135
