...
TARGET_TYPES=197               TARGET_MEMBERS=2439
COMPLETE_TYPES=192             PARTIAL_TYPES=5      MISSING_TYPE=60
MISSING_MEMBER=9              TOTAL_DIAGNOSTICS=71
ALLOWLIST_ENTRIES=0            UNMEASURED_STRUCTURAL_CATEGORY=0
NONDERIVABLE_UNSEALED_CLASSES=0    PENDING_BCL_BASE_TYPES=4
XNA_RESOURCE_STRING_PROJECTIONS=79 API_COMPAT_SELF_TESTS=2459
```

**Every remaining diagnostic is an absence.** Three categories are non-zero —
`MISSING_TYPE=60`, `MISSING_MEMBER=9`, and `OVERLOAD_MAPPING_MISMATCH=2`,
...
```text
BOUND_FUNCTIONS=402  ROUTE_PAIRINGS=402  PROTOTYPE_TYPE_POSITIONS=1403
CANONICAL_DECLARATION_CHECKS=1403  C_SWIFT_MEASUREMENTS=1403
...
PROJECTION_MUTATIONS=351  LAST_FULL_RUN=137  CAUGHT=135
