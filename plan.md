...
TARGET_TYPES=194               TARGET_MEMBERS=2400
COMPLETE_TYPES=190             PARTIAL_TYPES=4      MISSING_TYPE=63
MISSING_MEMBER=7              TOTAL_DIAGNOSTICS=72
ALLOWLIST_ENTRIES=0            UNMEASURED_STRUCTURAL_CATEGORY=0
NONDERIVABLE_UNSEALED_CLASSES=0    PENDING_BCL_BASE_TYPES=4
XNA_RESOURCE_STRING_PROJECTIONS=79 API_COMPAT_SELF_TESTS=2457
```

**Every remaining diagnostic is an absence.** Three categories are non-zero —
`MISSING_TYPE=63`, `MISSING_MEMBER=7`, and `OVERLOAD_MAPPING_MISMATCH=2`,
...
```text
BOUND_FUNCTIONS=360  ROUTE_PAIRINGS=360  PROTOTYPE_TYPE_POSITIONS=1250
CANONICAL_DECLARATION_CHECKS=1250  C_SWIFT_MEASUREMENTS=1250
LAYOUTS=55  LAYOUT_FIELDS=435  CALLBACKS=6  CONSTANTS=228  SCALAR_FACTS=3
MISSING_HEADER_SYMBOLS=0  MISSING_LIBRARY_SYMBOLS=0  ABI_MISMATCHES=0
NATIVE_ABI_MUTATIONS=14  CAUGHT=14  SURVIVORS=0
PROJECTION_MUTATIONS=334  LAST_FULL_RUN=137  CAUGHT=135
