...
TARGET_TYPES=221               TARGET_MEMBERS=2669
COMPLETE_TYPES=213             PARTIAL_TYPES=8      MISSING_TYPE=36
MISSING_MEMBER=16              TOTAL_DIAGNOSTICS=55
ALLOWLIST_ENTRIES=0            UNMEASURED_STRUCTURAL_CATEGORY=0
NONDERIVABLE_UNSEALED_CLASSES=0    PENDING_BCL_BASE_TYPES=4
XNA_RESOURCE_STRING_PROJECTIONS=79 API_COMPAT_SELF_TESTS=2494
```

**Every remaining diagnostic is an absence.** Three categories are non-zero —
`MISSING_TYPE=36`, `MISSING_MEMBER=16`, and `OVERLOAD_MAPPING_MISMATCH=3`,
...
```text
BOUND_FUNCTIONS=641  ROUTE_PAIRINGS=641  PROTOTYPE_TYPE_POSITIONS=2164
CANONICAL_DECLARATION_CHECKS=2164  C_SWIFT_MEASUREMENTS=2164
LAYOUTS=64  LAYOUT_FIELDS=494  CALLBACKS=9  CONSTANTS=228  SCALAR_FACTS=3
