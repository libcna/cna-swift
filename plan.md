...
TARGET_TYPES=198               TARGET_MEMBERS=2446
COMPLETE_TYPES=193             PARTIAL_TYPES=5      MISSING_TYPE=59
MISSING_MEMBER=9              TOTAL_DIAGNOSTICS=70
...
`MISSING_TYPE=59`, `MISSING_MEMBER=9`, and `OVERLOAD_MAPPING_MISMATCH=2`,
...
PROJECTION_MUTATIONS=354  LAST_FULL_RUN=137  CAUGHT=135
