...
TARGET_TYPES=217               TARGET_MEMBERS=2633
COMPLETE_TYPES=211             PARTIAL_TYPES=6      MISSING_TYPE=40
MISSING_MEMBER=10              TOTAL_DIAGNOSTICS=53
...
`MISSING_TYPE=40`, `MISSING_MEMBER=10`, and `OVERLOAD_MAPPING_MISMATCH=3`,
...
```text
BOUND_FUNCTIONS=596  ROUTE_PAIRINGS=596  PROTOTYPE_TYPE_POSITIONS=2007
CANONICAL_DECLARATION_CHECKS=2007  C_SWIFT_MEASUREMENTS=2007
