...
TARGET_TYPES=196               TARGET_MEMBERS=2431
COMPLETE_TYPES=192             PARTIAL_TYPES=4      MISSING_TYPE=61
MISSING_MEMBER=7              TOTAL_DIAGNOSTICS=70
...
`MISSING_TYPE=61`, `MISSING_MEMBER=7`, and `OVERLOAD_MAPPING_MISMATCH=2`,
...
```text
BOUND_FUNCTIONS=395  ROUTE_PAIRINGS=395  PROTOTYPE_TYPE_POSITIONS=1374
CANONICAL_DECLARATION_CHECKS=1374  C_SWIFT_MEASUREMENTS=1374
LAYOUTS=59  LAYOUT_FIELDS=462  CALLBACKS=6  CONSTANTS=228  SCALAR_FACTS=3
MISSING_HEADER_SYMBOLS=0  MISSING_LIBRARY_SYMBOLS=0  ABI_MISMATCHES=0
NATIVE_ABI_MUTATIONS=14  CAUGHT=14  SURVIVORS=0
PROJECTION_MUTATIONS=348  LAST_FULL_RUN=137  CAUGHT=135
