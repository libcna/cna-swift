...
TARGET_TYPES=211               TARGET_MEMBERS=2572
COMPLETE_TYPES=205             PARTIAL_TYPES=6      MISSING_TYPE=46
MISSING_MEMBER=13              TOTAL_DIAGNOSTICS=63
ALLOWLIST_ENTRIES=0            UNMEASURED_STRUCTURAL_CATEGORY=0
NONDERIVABLE_UNSEALED_CLASSES=0    PENDING_BCL_BASE_TYPES=4
XNA_RESOURCE_STRING_PROJECTIONS=79 API_COMPAT_SELF_TESTS=2463
```

**Every remaining diagnostic is an absence.** Three categories are non-zero —
`MISSING_TYPE=46`, `MISSING_MEMBER=13`, and `OVERLOAD_MAPPING_MISMATCH=4`,
...
```text
BOUND_FUNCTIONS=521  ROUTE_PAIRINGS=521  PROTOTYPE_TYPE_POSITIONS=1781
CANONICAL_DECLARATION_CHECKS=1781  C_SWIFT_MEASUREMENTS=1781
LAYOUTS=59  LAYOUT_FIELDS=462  CALLBACKS=7  CONSTANTS=228  SCALAR_FACTS=3
MISSING_HEADER_SYMBOLS=0  MISSING_LIBRARY_SYMBOLS=0  ABI_MISMATCHES=0
NATIVE_ABI_MUTATIONS=14  CAUGHT=14  SURVIVORS=0
PROJECTION_MUTATIONS=362  LAST_FULL_RUN=137  CAUGHT=135
