...
TARGET_TYPES=193               TARGET_MEMBERS=2394
COMPLETE_TYPES=189             PARTIAL_TYPES=4      MISSING_TYPE=64
MISSING_MEMBER=7              TOTAL_DIAGNOSTICS=73
...
`MISSING_TYPE=64`, `MISSING_MEMBER=7`, and `OVERLOAD_MAPPING_MISMATCH=2`,
...
```text
BOUND_FUNCTIONS=354  ROUTE_PAIRINGS=354  PROTOTYPE_TYPE_POSITIONS=1235
CANONICAL_DECLARATION_CHECKS=1235  C_SWIFT_MEASUREMENTS=1235
...
PROJECTION_MUTATIONS=325  LAST_FULL_RUN=137  CAUGHT=135
